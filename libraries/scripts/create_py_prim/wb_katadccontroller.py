...
def wb_katadccontroller_wrapper (block_name,
...
#======================
# wb_katadccontroller Instantiation
#======================
wb_katadccontroller_wrapper.verilog_code = \
"""
wb_katadccontroller
#(
...
) wb_katadccontroller_$block_name (
   .wb_clk_i($wb_clk_i),
   .wb_rst_i($wb_rst_i),
   .wb_we_i($wb_we_i),
   .wb_cyc_i($wb_cyc_i),
...
def convert():
   ...
   toVerilog(wb_katadccontroller_wrapper, block_name="inst", wb_clk_i = wb_clk_i, 
      wb_rst_i = wb_rst_i, 
      wb_we_i = wb_we_i, 
      wb_cyc_i = wb_cyc_i, 
      wb_stb_i = wb_stb_i, 
